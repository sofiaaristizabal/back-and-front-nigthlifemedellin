...
export const SignupDonador = () => {
    ...
    const handleSubmit = async (e: { preventDefault: () => void; }) => {
        ...
        try{
          ...
          const response = await fetch(url, {
            ...
            body: JSON.stringify({email, password, fullName, phoneNumber, contactPerson}),
        }); 
  ...
  return (
    ...
    <div className="absolute top-0 rigth-0 mt-12 mb-12 bg-blue-600 w-full h-18">
        ...
        <p className="mt-4 mb-4 text-white font-mono  text-xl font-bold text-center"> Registrate para ayudar a los demas</p>
    ...
    <div className="bg-gray-200 p-8 rounded-lg shadow-lg w-2/3 mt-36">
    ...
    >
      ...
      <div className="mb-4">
        <label className="block text-sm font-medium text-blue-500" htmlFor="email">Persona de contacto</label>
        <input
          type="text"
          id="contactPerson"
          value={contactPerson}
