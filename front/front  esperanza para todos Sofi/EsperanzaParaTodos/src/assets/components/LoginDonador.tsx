...
export const LoginDonador = () => {
    ...
    const handleSubmit = async (e: { preventDefault: () => void; }) => {
            ...
            body: JSON.stringify({email, password, roles}),
                ...
                if(response.ok){
                    ...
                    response.json().then((data) =>{
                      ...
                      const proveedorId = data.user.proveedorId;
      ...
      const handleSignUpClick = () =>{
        ...
        navigate("/SignupDonador");
     
     }

      const handleLoginPopupClose = () => {
        setLoginPopup(false);
        navigate("/PaginaDonador");
      };
  ...
  return (
    ...
    <div className=" mt-12 mb-12 bg-blue-500 w-96 h-18">

        <p className="mt-4 mb-4 text-gray-300  text-xl font-bold text-center"> Salva una vida, dona hoy</p>

    </div>

    <div className="absolute top-8 right-8">
    <Cross className="text-cyan-600" size={60}/>
      </div>
  ...
  <div className=" mt-14 bg-gray-200 p-8 rounded-lg shadow-lg w-96">
    ...
    <p  className="block text-sm font-medium text-black">No tienes una cuenta todavia? Registate para donar</p>
    <button 
